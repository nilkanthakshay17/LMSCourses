...
class CoursesServiceIntTest {
	...
	public void testFindByCourseId() {
		CourseDTO courseDto = coursesServiceInt.getCourseById("99999");
	...
	public void testFindCourseByNameContaining() {
		List<CourseDTO> courseDto = coursesServiceInt.getAllCoursesByName("DAC");
	...
	public void testFindCourseByDescriptionContaining() {
		List<CourseDTO> courseDto = coursesServiceInt.getAllCoursesByDescription("advanced computing");
	...
	public void testFindCourseByDurationContaining() {
		List<CourseDTO> courseDto = coursesServiceInt.getAllCoursesByDuration("999");
	...
	public void testFindCourseByTechnologyContaining() {
		List<CourseDTO> courseDto = coursesServiceInt.getAllCoursesByTechnology("Java999");
